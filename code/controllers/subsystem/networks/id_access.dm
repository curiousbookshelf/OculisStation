...
/datum/controller/subsystem/id_access/proc/setup_access_descriptions()
	...
	desc_by_access[ACCESS_CENT_GENERAL] = "SectCom General Access" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_GENERAL] = "CentCom General Access"
	desc_by_access[ACCESS_CENT_THUNDER] = "SectCom Thunderdome" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_THUNDER] = "CentCom Thunderdome"
	desc_by_access[ACCESS_CENT_STORAGE] = "SectCom Storage" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_STORAGE] = "CentCom Storage"
	desc_by_access[ACCESS_CENT_LIVING] = "SectCom Living Quarters" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_LIVING] = "CentCom Living Quarters"
	desc_by_access[ACCESS_CENT_MEDICAL] = "SectCom Medical" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_MEDICAL] = "CentCom Medical"
	desc_by_access[ACCESS_CENT_TELEPORTER] = "SectCom Teleporter" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_TELEPORTER] = "CentCom Teleporter"
	desc_by_access[ACCESS_CENT_SPECOPS] = "SectCom SpecOps" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_SPECOPS] = "CentCom SpecOps"
	desc_by_access[ACCESS_CENT_CAPTAIN] = "SectCom Captain" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_CAPTAIN] = "CentCom Captain"
	desc_by_access[ACCESS_CENT_BAR] = "SectCom Bar" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_BAR] = "CentCom Bar"
	desc_by_access[ACCESS_CENT_OFFICER] = "SectCom Officer" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc_by_access[ACCESS_CENT_OFFICER] = "CentCom Officer"

...
/datum/award/achievement/jobs/service_bad
	name = "SectCom Grade: Shitty Service" // OCULIS EDIT, SectCommening 2, ORIGINAL: name = "Centcom Grade: Shitty Service"
...
/datum/award/achievement/jobs/service_okay
	name = "SectCom Grade: Acceptable Service" // OCULIS EDIT, SectCommening 2, ORIGINAL: name = "Centcom Grade: Acceptable Service"
...
/datum/award/achievement/jobs/service_good
	name = "SectCom Grade: Exemplary Service" // OCULIS EDIT, SectCommening 2, ORIGINAL: name = "Centcom Grade: Exemplary Service"
	desc = "SectCom is very impressed with your department!" // OCULIS EDIT, SectCommening 2, ORIGINAL: desc = "Centcom is very impressed with your department!"

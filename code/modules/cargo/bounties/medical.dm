...
/datum/bounty/item/medical/appendix
	name = "Appendix"
	description = "Chef Gibb of Sectorial Command wants to prepare a meal using a very special delicacy: an appendix. If you ship one, he'll pay." // OCULIS EDIT, SectCommening 2, ORIGINAL: description = "Chef Gibb of Central Command wants to prepare a meal using a very special delicacy: an appendix. If you ship one, he'll pay."
...
/datum/bounty/item/medical/cat_tail
	name = "Cat Tail"
	description = "Sectorial Command has run out of heavy duty pipe cleaners. Can you ship over a cat tail to help us out?" // OCULIS EDIT, SectCommening 2, ORIGINAL: description = "Central Command has run out of heavy duty pipe cleaners. Can you ship over a cat tail to help us out?"
	reward = CARGO_CRATE_VALUE * 6

...
#define AGE_CHRONO_MAX 1000 // IRIS EDIT - Increased from 400 to 1000 //NOVA EDIT ADDITION - Chronological age
#define AGE_MINOR 18 //NOVA EDIT CHANGE - We dont use these features, and its easier to just patch it from here. Original: AGE_MINOR 18 //legal age of space drinking and smoking
...
/*	// IRIS EDIT REMOVAL START - It's okay for these layers to use shared appearences so long as the filters are reset before adding them as overlays
...
// NOVA EDIT END
// IRIS EDIT ADDITION - Customization
#define EXTERNAL_BACK (1 << 7)
// IRIS EDIT ADDITION END (not touching what comes next because we don't actually have to (nor want to))

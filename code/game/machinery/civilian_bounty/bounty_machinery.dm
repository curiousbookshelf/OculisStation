...
/obj/machinery/piratepad/civilian
	...
	desc = "A machine designed to send civilian bounty targets to SectCom." // OCULIS EDIT, SectCommening 2, ORIGINAL: desc = "A machine designed to send civilian bounty targets to centcom."
	layer = TABLE_LAYER

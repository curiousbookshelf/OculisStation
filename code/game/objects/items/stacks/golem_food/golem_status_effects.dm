...
/datum/bodypart_overlay/simple/golem_overlay/Destroy(force)
	var/obj/item/bodypart/referenced_bodypart = attached_bodypart?.resolve() // OCULIS EDIT, ORIGINAL: var/obj/item/bodypart/referenced_bodypart = attached_bodypart.resolve()
